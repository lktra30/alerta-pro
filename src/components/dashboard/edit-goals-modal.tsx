...
export function EditGoalsModal({ trigger, variant = "button" }: EditGoalsModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-md mx-auto max-h-[90vh] overflow-y-auto !w-[calc(100%-1.5rem)] sm:!w-[calc(100%-3rem)] md:!w-auto">
        <DialogHeader>
            ...
            <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-3">
              ...
              <div className="grid grid-cols-1 gap-2 text-xs">
                ...
                <div className="border-t pt-2">
                  ...
                  <span className="font-semibold">
                    {goals.find(g => g.id === "sdr")?.value || 0} reuniões
                  </span>
                </div>
              </div>
            </div>
